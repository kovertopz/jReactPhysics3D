...
public class Sphere extends Mesh {
    ...
    // Constructor
    public Sphere(float radius, Vector3 position, float mass, DynamicsWorld dynamicsWorld) {
        super();

        mRadius = radius;

        // Load the mesh from a file
        MeshReaderWriter.loadMeshFromFile("../meshes/sphere.obj", this);
        ...
        SphereShape collisionShape = new SphereShape(mRadius, 0.02f);
