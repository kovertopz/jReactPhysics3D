...
public class Cylinder extends Mesh {
    ...
    // Constructor
    public Cylinder(float radius, float height, Vector3 position, float mass, DynamicsWorld dynamicsWorld) {
        super();
        ...
        MeshReaderWriter.loadMeshFromFile("../meshes/cylinder.obj", this);
        ...
        CylinderShape collisionShape = new CylinderShape(mRadius, mHeight, 0.02f);
