...
public class TestMatrix3x3 {
    ...
    public void testOthersMethods() {
        ...
        // Test transpose
        Matrix3x3 test1 = new Matrix3x3(mMatrix1).transpose();
        ...
        Vector3 crossProduct2 = new Vector3();
        skewMatrix.multiply(vector2, crossProduct2);
    ...
    public void testOperators() {
        ...
        Matrix3x3 addition1 = new Matrix3x3(matrix1).add(matrix2);
        ...
        // Test substraction
        Matrix3x3 substraction1 = new Matrix3x3(matrix1).subtract(matrix2);
        ...
        Matrix3x3 multiplication2 = new Matrix3x3(matrix1).multiply(3);
        ...
        Matrix3x3 multiplication4 = new Matrix3x3(matrix1).multiply(matrix2);
        Matrix3x3 multiplication5 = new Matrix3x3(matrix2).multiply(matrix1);
